        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", maxLength: 150, nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BvnCipher = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    BvnHash = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    IsBvnSuccessfullyVerified = table.Column<bool>(type: "bit", nullable: true),
                    BvnVerifiedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    BvnVerificationReference = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    NinCipher = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    NinHash = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    IsNinSuccessfullyVerified = table.Column<bool>(type: "bit", nullable: true),
                    NinVerifiedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    NinVerificationReference = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WalletType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    VendorWalletId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Wallets_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lga = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    IsSuccessfullyVerified = table.Column<bool>(type: "bit", nullable: false),
